...
// 										  Define Module
// ==============================================================================
module PmodCLP( CLK, d10_1, d1_1, d10ths_1, d10_2, d1_2, d10ths_2, JB, JC, done );
	...
	// ===========================================================================
		...
		assign writeDone = ( lcd_cmd_ptr1 == 4'b1101 ) ? 1'b1 : 1'b0; // need to change this or remove this maybe
		...
		always @ ( stCur or delayOK or writeDone or lcd_cmd_ptr1 ) begin
			case ( stCur )
